...
- Backup-restore compatibility: backup files don't bind to `applicationId`, so a Y2K backup restores into upstream Yōkai and vice versa. Schema changes must not break round-tripping between forks.
