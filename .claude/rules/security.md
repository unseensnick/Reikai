...
- Tracker OAuth tokens, source preferences, and extension credentials live in `PreferencesHelper`. Treat them as secrets — don't expose via `toString()`, debug overlays, or copy-to-clipboard helpers.
