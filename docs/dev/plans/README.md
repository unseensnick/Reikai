...
- [Unified content UI (manga + novels + adult)](unified-content-ui.md): collapse the three near-duplicate presentation stacks into one Reikai-owned pixel layer rendering a content-agnostic UI model, killing the manga↔novel duplication and giving one place to move off stock Material 3. In progress; P1-P6 (list surfaces, cover dialog, details screen) shipped.
