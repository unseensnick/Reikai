...
Navigate to <nav to="browse"> and check the **Show in sources and extensions lists** option. It only takes effect after you restart the app, so nothing changes on the spot.
