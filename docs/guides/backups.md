...
All **Reikai** (and **Tachiyomi**) [forks](/forks/) support the `.tachibk`/`.proto.gz` format to backup/restore your library.
...
- These fork-specific settings will not be restored in **Reikai** and will be lost after restoring.
...
Be aware of these limitations when dealing with backups in different **Reikai** and **Tachiyomi** forks.
