 ...
 * The unified migration list ([reikai.presentation.migrate.flow.EntryMigrationListScreen]) runs the
 * same per-source fan-out per row; this composable backs the standalone global search.
 */
@Composable
