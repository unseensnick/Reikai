        ...
        Scaffold(
            topBar = { scrollBehavior ->
                AppBar(
                    ...
                    actionModeCounter = state.selectedUrls.size,
                    onCancelActionMode = screenModel::clearSelection,
                    actionModeActions = {
                        IconButton(onClick = screenModel::selectAll) {
                            Icon(Icons.Outlined.SelectAll, contentDescription = stringResource(MR.strings.action_select_all))
                        }
                        IconButton(onClick = screenModel::addSelectedToLibrary) {
                            Icon(Icons.Outlined.Add, contentDescription = stringResource(MR.strings.add_to_library))
                        }
                    },
