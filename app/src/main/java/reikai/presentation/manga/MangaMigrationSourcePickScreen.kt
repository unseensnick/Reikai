 ...
 * manga twin of the unified [reikai.presentation.migrate.flow.EntryMigrationSourcePickScreen]
 * (which replaces this screen at the manga cutover). Continue advances
    ...
    init {
        screenModelScope.launchIO {
            ...
            mangaIds.forEach { id ->
                ...
                mangaMergeManager.computeRelatedIds(manga.id).forEach { memberIds += it }
            }
