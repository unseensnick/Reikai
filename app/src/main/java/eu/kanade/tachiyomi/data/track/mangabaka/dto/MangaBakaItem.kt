...
data class MangaBakaItem(
    ...
    // RK --> Fill-from-tracker genres. Upstream parses no genres; the /v1/series endpoint exposes a
    // clean broad-category list (distinct from the 200+ granular `tags` we intentionally skip).
