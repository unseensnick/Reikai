    ...
    private fun imageQuality(
        ...
        return Preference.PreferenceItem.ListPreference(
            ...
            entries = mapOf(
                ...
                "ovrs_2400" to stringResource(MR.strings.eh_image_quality_2560),
                "ovrs_1600" to stringResource(MR.strings.eh_image_quality_1920),
                "high" to stringResource(MR.strings.eh_image_quality_1280),
                "low" to stringResource(MR.strings.eh_image_quality_800),
            ),
