...
class ExtensionStoresScreen(
    ...
    override fun Content() {
        ...
        ExtensionStoresScreen(
            ...
            // RK -->
            onClickCreateLn = { viewModel.showDialog(ExtensionStoreDialog.CreateLn) },
            onClickDeleteLn = { viewModel.showDialog(ExtensionStoreDialog.DeleteLn(it.indexUrl)) },
            // RK <--
        )
        ...
        when (val dialog = successState.dialog) {
            ...
            is ExtensionStoreDialog.CreateLn -> {
                ExtensionStoreCreateDialog(
                    onDismissRequest = viewModel::dismissDialog,
                    onCreate = { viewModel.createLnRepo(it) },
            ...
            is ExtensionStoreDialog.DeleteLn -> {
                ExtensionStoreDeleteDialog(
                    onDismissRequest = viewModel::dismissDialog,
                    onDelete = { viewModel.deleteLnRepo(dialog.url) },
