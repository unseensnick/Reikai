 ...
 * without modifying that class. [stop] also dismisses the in-progress library notification,
 * mirroring the legacy controller's Cancel-action body (LibraryController.kt:980-983).
 */
