 ...
 *
 * Numeric (not lexical) compare is load-bearing: `"2.0"` must rank above `"1.99"` (the lexical
 * compare would invert that).
 */
object LnPluginVersion {
    ...
    /**
     * Returns -1, 0, or 1 (matching `Int.compareTo` contract).
     * Returns 0 when both inputs are blank.
     */
