...
/**
 * WebView-based ExHentai login. Captures the member-id / pass-hash / igneous cookies into
 * [ExhPreferences] and flips [ExhPreferences.enableExhentai] on success, which makes the built-in
