...
class CanonicalizePluginUrlTest {
    ...
    fun `both bracket forms produce the same canonical`() {
        // This is the bug Slice C2 surfaced: the repo browse screen had `entry.url in
        // installedUrls` fail to match because the two forms compare unequal. Canonical must
        // collapse them.
