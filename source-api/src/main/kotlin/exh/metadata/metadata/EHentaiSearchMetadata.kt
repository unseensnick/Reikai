...
class EHentaiSearchMetadata : RaisedSearchMetadata() {
    ...
    override fun createMangaInfo(manga: SManga): SManga {
        ...
        // No title bug?
        val title = altTitle
            ?.takeIf { Injekt.get<DelegateSourcePreferences>().useJapaneseTitle().get() }
            ?: title
    ...
    override fun getExtraInfoPairs(context: Context): List<Pair<String, String>> {
        return with(context) {
            listOfNotNull(
                getItem(gId) { stringResource(MR.strings.id) },
                getItem(gToken) { stringResource(MR.strings.token) },
                getItem(exh) { stringResource(MR.strings.is_exhentai_gallery) },
                ...
                getItem(genre) { stringResource(MR.strings.genre) },
                getItem(
                    datePosted,
                    {
                ...
                getItem(parent) { stringResource(MR.strings.parent) },
                getItem(visible) { stringResource(MR.strings.visible) },
                getItem(language) { stringResource(MR.strings.language) },
                getItem(translated) { stringResource(MR.strings.translated) },
                getItem(size, { MetadataUtil.humanReadableByteCount(it, true) }) {
                    stringResource(MR.strings.gallery_size)
                },
                getItem(length) { stringResource(MR.strings.page_count) },
                getItem(favorites) { stringResource(MR.strings.total_favorites) },
                ...
                getItem(aged) { stringResource(MR.strings.aged) },
                getItem(
                    lastUpdateCheck,
                    {
                        MetadataUtil.EX_DATE_FORMAT
                ...
                ) { stringResource(MR.strings.last_update_check) },
            )
        }
    }
