...
- **More reader controls (General tab).** The novel reader settings gain a General tab: bionic reading (bold the start of each word), remove extra spacing, tap the top / bottom edge to scroll, and swipe left / right between chapters.
