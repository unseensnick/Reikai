...
- **Find saved galleries by tag in your library.** Library search now also matches the indexed tags of adult-source galleries (E-Hentai, nHentai, and the other enhanced sources), so typing a tag name surfaces every saved gallery carrying it. A dedicated E-Hentai settings screen (Settings → Advanced → E-Hentai) lets you log in to ExHentai and set image quality, Japanese titles, Hentai@Home, and tag thresholds; your choices are synced to your E-Hentai account automatically.
