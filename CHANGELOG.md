...
- **Light-novel sources that name their language differently no longer split into two sections.** Some plugins say "Spanish" and others "es", which read as two languages.
