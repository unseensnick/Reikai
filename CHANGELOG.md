...
- **Tap a series in the download queue to see its chapters, cancel one, start one now, or read why it failed.** A downloading manga chapter shows its page count.
