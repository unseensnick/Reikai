...
- **Light novels now appear in the Updates tab.** An **All / Manga / Novels** chip below the Updates title brings recent new chapters of your favorited novels alongside manga; the **All** view interleaves both by date, the Manga chip keeps the full manga updates screen (filters, calendar, selection), and the Novels chip shows novels on their own. Tap a novel update to start reading it, download it from the row, or long-press to select novels and mark read/bookmark/download. With novels in the feed, the **"Show unread count on Updates icon"** badge now counts new novel chapters too.
