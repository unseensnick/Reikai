...
- In the chapter multi-select bar, the read action **flips to "Mark as unread" when every selected chapter is already read** (a mixed selection stays "Mark as read"), mirroring the bookmark toggle.
