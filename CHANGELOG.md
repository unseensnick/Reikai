...
- **Migrating novels now runs in a redesigned flow.** Compact match rows with inline overrides, pre-search options, safer exits, and clear progress with per-entry retry.
